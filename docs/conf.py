...
html_short_title = 'Conformity'
html_static_path = ['_static']
html_theme = 'alabaster'
html_theme_options = {
    'fixed_sidebar': True,
    'github_button': True,
    'github_repo': 'conformity',
    'github_user': 'eventbrite',
}
html_title = 'Conformity - Declarative Schema for Python'
html_use_index = True
...
linkcode_resolve = create_linkcode_resolve('eventbrite', 'conformity', 'conformity', __version__)
